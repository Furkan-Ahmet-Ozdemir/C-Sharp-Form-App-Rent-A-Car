...
namespace Rent_A_Car {
    ...
    public partial class _rent_a_carDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/_rent_a_carDataSet1.xsd";
        ...
        public partial class USERDataTable : global::System.Data.TypedTableBase<USERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public USERRow AddUSERRow(string USER_NAME, string NAME, string LAST_NAME, string TC, short AGE, string GENDER, string PASSWORD) {
        ...
        public partial class USERRow : global::System.Data.DataRow {
            ...
            public string TC {
                get {
                    return ((string)(this[this.tableUSER.TCColumn]));
                }
                set {
            ...
            public short AGE {
                get {
                    return ((short)(this[this.tableUSER.AGEColumn]));
                }
                set {
...
namespace Rent_A_Car._rent_a_carDataSetTableAdapters {
    ...
    public partial class USERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[USER] WHERE (([ID] = @Original_ID) AND ([USER_NAME] = @Original_USER_NAME) AND ([NAME] = @Original_NAME) AND ([LAST_NAME] = @Original_LAST_NAME) AND ([TC] = @Original_TC) AND ([AGE] = @Original_AGE) AND ([GENDER] = @Original_GENDER) AND ([PASSWORD] = @Original_PASSWORD))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[USER] ([USER_NAME], [NAME], [LAST_NAME], [TC], [AGE], [GENDER], [PASSWORD]) VALUES (@USER_NAME, @NAME, @LAST_NAME, @TC, @AGE, @GENDER, @PASSWORD);
SELECT ID, USER_NAME, NAME, LAST_NAME, TC, AGE, GENDER, PASSWORD FROM [USER] WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[USER] SET [USER_NAME] = @USER_NAME, [NAME] = @NAME, [LAST_NAME] = @LAST_NAME, [TC] = @TC, [AGE] = @AGE, [GENDER] = @GENDER, [PASSWORD] = @PASSWORD WHERE (([ID] = @Original_ID) AND ([USER_NAME] = @Original_USER_NAME) AND ([NAME] = @Original_NAME) AND ([LAST_NAME] = @Original_LAST_NAME) AND ([TC] = @Original_TC) AND ([AGE] = @Original_AGE) AND ([GENDER] = @Original_GENDER) AND ([PASSWORD] = @Original_PASSWORD));
SELECT ID, USER_NAME, NAME, LAST_NAME, TC, AGE, GENDER, PASSWORD FROM [USER] WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, USER_NAME, NAME, LAST_NAME, TC, AGE, GENDER, PASSWORD FROM dbo.[USER]";
        ...
        public virtual int Fill(_rent_a_carDataSet.USERDataTable dataTable) {
        ...
        public virtual _rent_a_carDataSet.USERDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            _rent_a_carDataSet.USERDataTable dataTable = new _rent_a_carDataSet.USERDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(_rent_a_carDataSet.USERDataTable dataTable) {
        ...
        public virtual int Delete(short Original_ID, string Original_USER_NAME, string Original_NAME, string Original_LAST_NAME, string Original_TC, short Original_AGE, string Original_GENDER, string Original_PASSWORD) {
        ...
        public virtual int Insert(string USER_NAME, string NAME, string LAST_NAME, string TC, short AGE, string GENDER, string PASSWORD) {
            if ((USER_NAME == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((short)(Original_AGE));
            if ((Original_GENDER == null)) {
                throw new global::System.ArgumentNullException("Original_GENDER");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string USER_NAME, string NAME, string LAST_NAME, string TC, short AGE, string GENDER, string PASSWORD, short Original_ID, string Original_USER_NAME, string Original_NAME, string Original_LAST_NAME, string Original_TC, short Original_AGE, string Original_GENDER, string Original_PASSWORD) {
            return this.Update(USER_NAME, NAME, LAST_NAME, TC, AGE, GENDER, PASSWORD, Original_ID, Original_USER_NAME, Original_NAME, Original_LAST_NAME, Original_TC, Original_AGE, Original_GENDER, Original_PASSWORD, Original_ID);
        }
    }
